...
const AGENTS_CONFIG_PATH = path.join(REPO_ROOT, "multi-tenant", "clients", "internal-demo", "agents.json");
  ...
  apps: [
    {
      ...
      env: {
        ...
        LOG_FILE_PATH: path.join(REPO_ROOT, "logs", "demo-local", "bot.log"),
        SECURITY_LOG_PATH: path.join(REPO_ROOT, "logs", "demo-local", "security.log")
      }
    },
    {
      name: "dashboard-humano-demo-local",
      cwd: DASHBOARD_CWD,
      script: "server.js",
      env: {
        NODE_ENV: "production",
