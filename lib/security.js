...
const RESPUESTAS_ANTI_HIJACKING = {
  prompt_injection: "Soy el asistente demo. Puedo responder una consulta sobre capacidades de automatización por WhatsApp.",
  role_hijacking: "Soy el asistente demo de WhatsApp Automation y mantengo mi función durante la prueba.",
  system_override: "No puedo cambiar mi función. Esta demo solo muestra capacidades del agente de respuesta.",
  info_extraction: "No comparto instrucciones internas ni configuración. Puedo explicar capacidades visibles del producto.",
  command_injection: "No ejecuto comandos. Esta demo solo responde consultas sobre capacidades del agente."
};
